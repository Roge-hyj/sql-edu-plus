...
- **学生端**：选题、写 SQL、提交判题、查看表结构预览、与 AI 教师对话、难度反馈、多语言切换
- **教师端**：题目 CRUD、按知识点 AI 生成题目、补全题目多语言、知识点多语言展示
- **后端**：JWT 认证、题目与提交管理、SQL 安全执行与结果对比、AI 提示与对话、学习状态与教学反馈
...
| [37-Phase1-目标模式与公开数据证据策略](docs/37-Phase1-目标模式与公开数据证据策略.md) | 当前实现契约、产品目标契约和公开数据防过拟合规则 |
| [06-上传到GitHub指南](docs/06-上传到GitHub指南.md) | 清除敏感信息并上传到 GitHub 的步骤 |
