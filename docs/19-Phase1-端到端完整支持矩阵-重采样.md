...
|---|---:|---:|---:|---:|---:|---:|
| web_common250 (无方言) | 250 | 244 | 196 | 227 | 175 | 70.0% |
| online_random250 (有方言) | 250 | 226 | 154 | 197 | 117 | 46.8% |

## 按结构统计

| SQL 结构 | web 闭环/总数 | online 闭环/总数 | 当前结论 |
|---|---:|---:|---|
| SELECT | 11/11 | 13/15 | 稳定支持 |
| DISTINCT | 11/11 | 4/15 | 短板，需继续定向修复 |
...
- 无方言组端到端闭环 175/250，闭环率 70.0%。
- 有方言组端到端闭环 117/250，闭环率 46.8%。
